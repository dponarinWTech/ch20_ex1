-- create and select the database for Lesson 13 assignment
DROP DATABASE IF EXISTS my_guitar_shop2edited;
CREATE DATABASE my_guitar_shop2edited;
USE my_guitar_shop2edited; 
